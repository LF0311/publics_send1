...
def read_files_split(df):
    ...
    id_sent_list = []
    n_e_dic = {
        '17': [118.94371085716686, 32.04948002478078], '33': [118.9440911184693, 32.04922271168032],
        '49': [3118.94487719912863, 32.04973320987654], '65': [118.9446791999385, 32.04932049263779],
        ...
        '145': [118.94358289420882, 32.04911455074194], '161': [118.94434884839787, 32.04846220427181],
                ...
                if len(read_file_df) > 0:
                    ...
                    if 55 not in unique_ids:
                        ...
                        if all(value == '无' for value in target_mblb_tmp.values()):
                            ...
                            trans_data_1.update(
                                {
                                    'JDMIN': str(final_read_file_df['N'].min()),
                                    'JDMAX': str(final_read_file_df['N'].max()),
                                    'WDMIN': str(final_read_file_df['E'].min()),
                                    'WDMAX': str(final_read_file_df['E'].max()),
                                    'MBLB': target_mblb,
                                    'MBGS': str(1),
                                    'SBXH': '振动',
